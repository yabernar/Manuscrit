	...
	\begin{enumerate}
		...
		\begin{figureth}
			\begin{subfigureth}{0.24\textwidth}
				\includegraphics[width=\linewidth]{CDNET/baseline/in000277}\caption{Couleurs fusionnées}	
			\end{subfigureth}
			\begin{subfigureth}{0.24\textwidth}
				\includegraphics[width=\linewidth]{CDNET/baseline/in000895}\caption{Couleurs séparées}	
			\end{subfigureth}
			\begin{subfigureth}{0.24\textwidth}
				\includegraphics[width=\linewidth]{CDNET/baseline/in000473}\caption{Couleurs séparées}	
			\end{subfigureth}
			\begin{subfigureth}{0.24\textwidth}
				\includegraphics[width=\linewidth]{CDNET/baseline/in000118}\caption{Couleurs séparées}	
			\end{subfigureth}
