...
% Début du chapitre
	...
	\begin{figureth}
		\begin{subfigureth}{.45\textwidth}
			\includegraphics[width=\linewidth]{resultats/neurones_imagettes/global}\caption{SOM}
		\end{subfigureth}
		\begin{subfigureth}{.45\textwidth}
