...
\usepackage{siunitx}
\sisetup{output-exponent-marker=\ensuremath{\mathrm{e}}, mode=text, detect-weight, locale = FR, inter-unit-separator=$\cdot$,range-phrase=~\`{a}~,range-units=single}
\newcommand{\bst}[1]{\bfseries $\num{#1}$}
\newcommand{\nbr}[1]{$\num{#1}$}
