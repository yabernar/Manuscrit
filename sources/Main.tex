...
\date{2021}
\jurya{M. Alan Turing}{Professeur}{Examinateur}
\juryb{Mme. Margaret Hamilton}{Professeur}{Rapporteur}
\juryc{M. Emil L. Post}{Professeur}{Examinateur}
\juryd{M. Ken Thompson}{Professeur}{Examinateur}
...
\hypersetup{
    ...
    pdfkeywords={Neuromorphique, déformation plastique, titane, TA6V}
}
